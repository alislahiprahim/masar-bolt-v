...
import { faChevronLeft, faExpand, faSpinner } from '@fortawesome/free-solid-svg-icons';
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @if (state.loading()) {
          ...
          <div class="text-center py-12">
            ...
            <button (click)="loadFeaturedImages()" class="mt-4 btn-primary">Try Again</button>
          </div>
        } @else {
              ...
              <div
                ...
                <div
                  ...
                  <div class="absolute top-4 right-4">
                    <fa-icon
                      [icon]="faExpand"
                      class="text-white text-xl opacity-75 hover:opacity-100"></fa-icon>
                  </div>
                </div>
              </div>
            }

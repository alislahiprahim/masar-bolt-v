...
@Component({
  ...
  imports: [CommonModule, RouterLink, FontAwesomeModule, TranslateModule, TripCardComponent],
  template: `
    <section class="py-20">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @if (state.loading()) {
          ...
          <div class="text-center py-12">
            ...
            <button (click)="loadPopularTrips()" class="mt-4 btn-primary">Try Again</button>
          </div>
        } @else {

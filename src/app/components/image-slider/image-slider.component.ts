  ...
  template: `
    <div class="container mx-auto px-4">
      ...
      <div class="flex flex-wrap">
        ...
        <div *ngIf="images.length > 0" class="w-full md:w-1/2 lg:w-1/3 p-2 relative">
          <div class="relative overflow-hidden rounded-lg h-full min-h-64">
            <img [src]="images[0]" alt="Image" class="w-full h-full object-cover" />
            <!-- "All Photos" Button -->
            <div class="absolute bottom-0 left-0 right-0 p-4">
              <button
                ...
                <fa-icon [icon]="faImagePortrait" class="mx-2 "></fa-icon>
      ...
      <div
        *ngIf="lightboxOpen"
        ...
        <div class="max-w-6xl mx-auto px-4 relative" (click)="$event.stopPropagation()">
          <!-- Close Button -->
          <button class="absolute top-4 right-4 text-white text-2xl z-10" (click)="closeLightbox()">
            <svg

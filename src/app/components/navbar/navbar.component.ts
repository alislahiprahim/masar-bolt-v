...
@Component({
  selector: 'app-navbar',
  standalone: true,
  imports: [CommonModule, RouterLink, RouterLinkActive, FontAwesomeModule, TranslateModule],
  template: `
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden sm:ml-8 sm:flex sm:space-x-4 rtl:space-x-reverse rtl:mr-8">
              <a
          ...
          <div class="flex items-center gap-2">
            ...
            <div class="hidden sm:flex items-center gap-2">
              @if (authService.isAuthenticated()) {
                ...
                <button
                  (click)="logout()"
                  class="flex items-center gap-2 text-gray-700 hover:text-primary-600 transition-colors">
                  <fa-icon [classList]="['rtl:rotate-180']" [icon]="faSignOutAlt"></fa-icon>
                ...
                <a
                  ...
                  class="flex items-center gap-2 text-gray-700 hover:text-primary-600 transition-colors">
                  <fa-icon [classList]="['rtl:rotate-180']" [icon]="faSignInAlt"></fa-icon>
            ...
            <button
              ...
              <fa-icon [icon]="isDrawerOpen ? faTimes : faBars" size="lg"></fa-icon>
            </button>
          </div>
        </div>
      </div>

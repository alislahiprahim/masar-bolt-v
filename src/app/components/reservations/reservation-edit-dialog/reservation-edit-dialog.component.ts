        ...
        <div
          ...
          <div
            ...
            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              ...
              <!-- Form -->
              <form [formGroup]="editForm" (ngSubmit)="handleSubmit()" class="space-y-4">
                <!-- Number of Travelers -->
                <div>
                  ...
                  <input
                    ...
                    min="1" />
                  @if (
                    editForm.get('numberOfTravelers')?.errors?.['required'] &&
                  ...
                  @if (
                    editForm.get('numberOfTravelers')?.errors?.['min'] &&
                    editForm.get('numberOfTravelers')?.touched
                  ) {
                    <p class="mt-1 text-sm text-red-600">
                ...
                <div>
                  ...
                  <input
                    ...
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500" />
                  @if (
                    editForm.get('whatsappNumber')?.errors?.['required'] &&
                  ...
                  @if (
                    editForm.get('whatsappNumber')?.errors?.['pattern'] &&
                    editForm.get('whatsappNumber')?.touched
                  ) {
                    <p class="mt-1 text-sm text-red-600">
...
export class ReservationEditDialogComponent {
  ...
  constructor(private fb: FormBuilder) {
    this.editForm = this.fb.group({
      ...
      whatsappNumber: ['', [Validators.required, Validators.pattern('^(10|11|12|15)[0-9]{8}$')]],
      specialRequests: [''],
    });
  }

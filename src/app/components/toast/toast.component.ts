...
@Component({
  ...
  template: `
    <div
      class="fixed top-16 right-0 p-4 z-50 max-h-screen overflow-hidden pointer-events-none"
      ...
      <div class="flex flex-col gap-2">
        @for (toast of toastService.toasts(); track toast.id) {
          <div
            ...
            role="alert">
            <fa-icon [icon]="getIcon(toast.type)" [class]="getIconClasses(toast.type)" size="lg">
            </fa-icon>

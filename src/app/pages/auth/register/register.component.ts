...
@Component({
  ...
  imports: [RouterLink, ReactiveFormsModule, FontAwesomeModule, TranslateModule, NgClass],
  template: `
    ...
    this.registerForm = this.fb.group(
      {
        ...
        phoneNumber: ['', [Validators.required, Validators.pattern('^0(10|11|12|15)[0-9]{8}$')]],

      ...
      <div class="space-y-6">
        ...
        >
          <div class="p-6">
            ...
            <div class="mt-6 flex justify-end space-x-4">
              ...
              <a
                [routerLink]="['/reviews', 'new', booking.tripId]"
              ...
              <button
                (click)="downloadItinerary(booking.id)"
        ...
        <div class="text-center py-12 bg-white rounded-lg shadow">
          <p class="text-gray-500 mb-4">
            @if (statusFilter !== 'all') { No bookings found with the selected
            status. } @else { You haven't made any bookings yet. }
          </p>
          <a routerLink="/trips" class="btn-primary inline-block">
  ...
  bookings: Booking[] = [
    {
      ...
      whatsappNumber: "1012345678",
      nationalIdImage: "https://example.com/id1.jpg",
      numberOfTravelers: 2,
      totalPrice: 2598,
    ...
    },
    {
      ...
      nationalIdImage: "https://example.com/id2.jpg",
      numberOfTravelers: 1,
      totalPrice: 1299,
      specialRequests: "",
    },

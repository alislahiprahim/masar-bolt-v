    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="flex justify-between items-center mb-8">
        <div>
          ...
          <p class="text-gray-600 mt-2">{{ reviews.length }} reviews • Average rating: {{ averageRating }}</p>
        </div>
          ...
          <div>
            ...
            @for (rating of [5,4,3,2,1]; track rating) {
              <div class="flex items-center gap-4 mb-2">
                ...
                <span class="w-12 text-sm text-gray-600">{{ getRatingCount(rating) }}</span>
              </div>
            }
          </div>
          <div>
            ...
            <div class="space-y-2">
              <p class="text-gray-600">
                <span class="font-medium">{{ getPositiveReviewsPercentage() }}%</span> of reviews are 4 stars or higher
              </p>
              <p class="text-gray-600">
              ...
              <div class="mt-1 flex items-center space-x-2">
                @for (star of [1, 2, 3, 4, 5]; track star) {
                  <button type="button"
                          ...
                          [class.hover:text-yellow-300]="star > (reviewForm.get('rating')?.value || 0)">
                    ★
                  </button>
                }
          ...
          <div class="bg-white shadow rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-200">
            <div class="p-6">
              <div class="flex items-center justify-between mb-4">
                <div>
                  <h3 class="text-lg font-semibold text-gray-900">{{ review.userName }}</h3>
                  <p class="text-sm text-gray-500">{{ review.date | date }}</p>
                </div>
                <div class="flex text-yellow-400">
                  @for (star of [1, 2, 3, 4, 5]; track star) {
                    <span [class.text-yellow-400]="star <= review.rating"
  ...
  reviews: Review[] = [
    {
      ...
      tripId: 'trip1',
      rating: 5,
      comment: 'Amazing experience! The trip was perfectly organized and exceeded all our expectations.',
      date: '2024-02-15',
      userName: 'John Doe',
      helpful: 3
    },
    {
      ...
      tripId: 'trip1',
      rating: 4,
      comment: 'Great trip overall. The guides were knowledgeable and friendly. Would recommend!',
      date: '2024-02-10',
      userName: 'Jane Smith',
      helpful: 1
    }

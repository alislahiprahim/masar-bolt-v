    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex gap-4">
          <select [(ngModel)]="sortBy" (change)="applySort()" class="input-field">
            <option value="date-desc">Most Recent</option>
            <option value="date-asc">Oldest First</option>
            <option value="rating-desc">Highest Rated</option>
            <option value="rating-asc">Lowest Rated</option>
          </select>
          <select [(ngModel)]="ratingFilter" (change)="applyFilters()" class="input-field">
          ...
          <div>
            ...
            <div class="space-y-2">
              <p class="text-gray-600">
                <span class="font-medium">{{ getPositiveReviewsPercentage() }}%</span>
        ...
        <div class="p-6">
          ...
          <form [formGroup]="reviewForm" (ngSubmit)="submitReview()" class="space-y-4">
            ...
            <div class="flex justify-end">
              <button type="submit" [disabled]="!reviewForm.valid" class="btn-primary">
                Submit Review
              </button>
            </div>
          </form>
